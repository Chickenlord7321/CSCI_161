...
/**
 * Tester for the maze assignment.
 * @author B. Bultena
 * For use in VIU CSCI 161 Assignment 2024.
 */
 ...
 * @param argc The number of strings (delimited by whitespace) that follow
...
int main(int argc, char ** argv) {
	...
	// The dispenser is used as a stack during the solve
	// process, and will contain the solution path if there is a solution
	Dispenser<Cell> soln = maze.solve();
	if (soln.is_empty()) {
		cout << "No path!\n";
	} else {
		cout << "Solution found\n";
		cout << soln.elements_bottom_up();
		cout << endl;
	}
